import { C as InvalidImageService, H as RemoteImageNotAllowed, c as ExpectedImageOptions, l as ExpectedNotESMImage, s as ExpectedImage, tt as AstroError } from "./errors-data_CGrY2m_4.mjs";
import { i as isRemoteAllowed, t as inferRemoteSize } from "./remoteProbe_DVs-xGa4.mjs";
import { a as isESMImportedImage, i as resolveDefaultOutputFormat, n as isLocalService, o as isRemoteImage, s as resolveSrc } from "./service_KG_zPkHg.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_CNREWxMq.mjs").catch((e) => {
