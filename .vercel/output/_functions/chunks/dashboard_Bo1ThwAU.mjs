...
var $$ShowCSR = createComponent(($$result, $$props, $$slots) => {
	...
	return renderTemplate`${renderComponent($$result, "clerk-show", "clerk-show", {
		...
		"data-plan": plan,
		"class": className
	}, { "default": ($$result) => renderTemplate`${maybeRenderHead($$result)}<div hidden data-clerk-control-slot-default>${renderSlot($$result, $$slots["default"])}</div><div hidden data-clerk-control-slot-fallback>${renderSlot($$result, $$slots["fallback"])}</div>` })}${renderScript($$result, "/root/Projects/youtube-summary-ai/node_modules/@clerk/astro/components/control/ShowCSR.astro?astro&type=script&index=0&lang.ts")}`;
}, "/root/Projects/youtube-summary-ai/node_modules/@clerk/astro/components/control/ShowCSR.astro", void 0);
//#endregion
...
}, "/root/Projects/youtube-summary-ai/node_modules/@clerk/astro/components/control/ShowSSR.astro", void 0);
//#endregion
...
}, "/root/Projects/youtube-summary-ai/node_modules/@clerk/astro/components/control/Show.astro", void 0);
//#endregion
...
}, "/root/Projects/youtube-summary-ai/node_modules/@clerk/astro/components/interactive/InternalUIComponentRenderer.astro", void 0);
//#endregion
...
}, "/root/Projects/youtube-summary-ai/node_modules/@clerk/astro/components/interactive/UserButton/UserButton.astro", void 0);
//#endregion
...
}, "/root/Projects/youtube-summary-ai/node_modules/@clerk/astro/components/interactive/UserButton/MenuItemRenderer.astro", void 0);
//#endregion
...
}, "/root/Projects/youtube-summary-ai/node_modules/@clerk/astro/components/interactive/UserButton/UserButtonLink.astro", void 0);
//#endregion
...
}, "/root/Projects/youtube-summary-ai/node_modules/@clerk/astro/components/interactive/UserButton/UserButtonAction.astro", void 0);
//#endregion
...
var $$UserButtonMenuItems = createComponent(($$result, $$props, $$slots) => {
	return renderTemplate`${renderComponent($$result, "clerk-user-button-menu-items", "clerk-user-button-menu-items", {}, { "default": ($$result) => renderTemplate`${renderSlot($$result, $$slots["default"])}` })}${renderScript($$result, "/root/Projects/youtube-summary-ai/node_modules/@clerk/astro/components/interactive/UserButton/UserButtonMenuItems.astro?astro&type=script&index=0&lang.ts")}`;
}, "/root/Projects/youtube-summary-ai/node_modules/@clerk/astro/components/interactive/UserButton/UserButtonMenuItems.astro", void 0);
//#endregion
...
}, "/root/Projects/youtube-summary-ai/node_modules/@clerk/astro/components/interactive/UserButton/UserButtonUserProfilePage.astro", void 0);
//#endregion
...
}, "/root/Projects/youtube-summary-ai/src/pages/dashboard.astro", void 0);
var $$file = "/root/Projects/youtube-summary-ai/src/pages/dashboard.astro";
var $$url = "/dashboard";
//#endregion
